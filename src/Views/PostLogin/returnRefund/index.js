      ...
      <Box className="main-container">
        <Container>
          <Box className="condition-contents-container">
            ...
            <p>
              Product must be returned to us within <b>1 - 2 days</b> from the date
            ...
            <p>
              ...
              be within 1 - 2 business days of shipping (business days exclude
              Sundays and other holidays). For other areas the products will be
              shipped through  and may take 1 - 2 days depending
